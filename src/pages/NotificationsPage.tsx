...
import { NotificationRow } from '@/types/Notificationtypes'
  ...
  return (
    <div className='max-w-3xl mx-auto p-6'>
      ...
      {notifications.length === 0 ? (
        <div className='mt-6 text-sm text-slate-500'>No notifications yet.</div>
      ) : (
          ...
          {notifications.map(n => (
            ...
            >
              <div className='flex items-center justify-between gap-2'>
                <div className='font-semibold text-sm'>{renderTitle(n)}</div>
